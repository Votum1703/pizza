...
type CartItemProps = {id: string, title: string, type: string, price: number,count: number,size: number,imageUrl: string}

 const CartItemBlock: React.FC<CartItemProps> = ({id,title,type,price,count,size,imageUrl}) => {
